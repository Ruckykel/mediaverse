...
export function OurStory() {
  return (
    <section aria-label="Our Story" className="py-16">
      <Container>
        <div className="max-w-6xl mx-auto grid grid-cols-1 gap-10 lg:grid-cols-2 items-start">
          <div>
            ...
            <p className="mt-4 text-sm md:text-base text-white/70 max-w-2xl">
              Mediaverse started as a vision — a belief that great content goes beyond aesthetics; it inspires connection.
          ...
          <div>
            <figure className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-card">
              ...
              <figcaption className="mt-3 text-xs text-white/60">The Mediaverse ethos</figcaption>
            </figure>
          </div>
        </div>
      </Container>
